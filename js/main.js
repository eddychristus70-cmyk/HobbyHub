...
document.addEventListener("DOMContentLoaded", () => {
  ...
  /* ---------- Header search — expandable icon, redirects to Browse with query ---------- */
  ...
  if (navSearchToggle && navSearchWrap) {
    ...
    navSearchWrap.addEventListener("click", (e) => e.stopPropagation());
...
function renderListingCard(listing) {
  ...
  const imgSrc =
    listing.imageUrl && listing.imageUrl.trim() ? listing.imageUrl : "";
  const dateLabel = listing.dateAvailable
    ? new Date(listing.dateAvailable).toLocaleDateString(undefined, {
        month: "short",
        day: "numeric",
      })
    : "";
